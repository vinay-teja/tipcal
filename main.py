...
Currency = input("Please enter your currency!: $ or Rs. or Yen \n")
...
tip_Percentage = int(
    input("Choose  your top percentage: Example: 10 or 12 or 15? \n"))
...
print(f"Each person pays {Currency} {final_total}")
